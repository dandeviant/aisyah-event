  ...
  return (
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
        <div className="h-20 sticky top-0 z-20 navbar bg-gray-700">
          <div className="navbar-start right-full h-10/10">
            <Link href="/">
              <button className="btn btn-ghost bg-gray-700 text-white hover:bg-white hover:text-black h-20">Icon</button>
            </Link>
          </div>
          <div className="navbar-center">
            <ul className="menu-horizontal flex items-center lg:flex hidden">
              <li className="menu menu-lg">
                  <Link href="/" className="text-center hover:bg-gray-700 hover:text-cyan-400">Home</Link>
              </li>
              <li className="menu menu-lg">
                  <Link href="/catalogue" className="text-center hover:bg-gray-700 hover:text-cyan-400 text-lg"><b>Catalogue</b></Link>
              </li>
              <li className="menu menu-lg">
                  <Link href="/facilities" className="text-center hover:bg-gray-700 hover:text-cyan-400">Facilities</Link>
              </li>
              <li className="menu menu-lg">
      ...
      <footer className="footer sticky sm:footer-horizontal bg-neutral text-neutral-content p-10">
        <aside>
          <svg
            width="50"
            height="50"
