  ...
  return (
     <div className="h-20 sticky top-0 z-20 navbar bg-gray-700 text-white">
          ...
          <div className="navbar-end h-full">
               {/* WhatsApp shortcut */}
               <div className='h-full group hidden lg:flex pr-15 flex center items-center justify-center' >
                    <Link href="https://wa.me/60148033304" target="_blank">
                         <div className="h-16 w-65 rounded-4xl flex center items-center justify-center bg-green-600 text-white-300 hover:text-green-600 hover:bg-white transition ease-in duration-150">
                              <a aria-label="Chat on WhatsApp" className="w-4/5 flex items-center justify-center">
                              ...
                              <div className='w-9/10 h-10 flex items-center justify-center'>
                                   <b>WhatsApp Link</b>
                              </div>
                              </a>
                         </div>
